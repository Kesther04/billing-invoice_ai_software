...
//     >
//       {/* Mobile menu btn + logo — mobile/small screens only */}
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center gap-3 md:hidden w-full relative">
        ...
        {isProfileOpen && (
          <div className={`absolute top-14 right-0 w-72 rounded-2xl border p-4 shadow-xl flex flex-col gap-4 z-40 animate-in fade-in slide-in-from-top-2 duration-200 ${t.topbar(dark)}`}>
            {/* User Metadata */}
